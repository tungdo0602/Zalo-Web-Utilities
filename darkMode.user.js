...
window.setInterval(()=>{
    ...
    try{
        ...
        Array.from(document.querySelectorAll(".chat-message__actions")).map(n=>n.style.backgroundColor='#21252b');
    }catch{}
    /*Main 2*/
    try{
